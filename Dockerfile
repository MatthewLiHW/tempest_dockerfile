...
RUN apt-get install -y git python-setuptools curl ftp wget vim
RUN wget https://raw.github.com/pypa/pip/master/contrib/get-pip.py -O /tmp/pip.py
RUN python /tmp/pip.py && rm /tmp/pip.py
